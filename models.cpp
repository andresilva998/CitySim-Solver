...
float evaluateUTCI(float Ta, float va, float Pa, float D_Tmrt) {
    return Ta +
        (6.07562052e-01f) +
        (-2.27712343e-02f) * Ta +
        (8.06470249e-04f) * Ta * Ta +
        (-1.54271372e-04f) * Ta * Ta * Ta +
        (-3.24651735e-06f) * Ta * Ta * Ta * Ta +
        (7.32602852e-08f) * Ta * Ta * Ta * Ta * Ta +
        (1.35959073e-09f) * Ta * Ta * Ta * Ta * Ta * Ta +
        (-2.25836520e+00f) * va +
        (8.80326035e-02f) * Ta * va +
        (2.16844454e-03f) * Ta * Ta * va +
        (-1.53347087e-05f) * Ta * Ta * Ta * va +
        (-5.72983704e-07f) * Ta * Ta * Ta * Ta * va +
        (-2.55090145e-09f) * Ta * Ta * Ta * Ta * Ta * va +
        (-7.51269505e-01f) * va * va +
        (-4.08350271e-03f) * Ta * va * va +
        (-5.21670675e-05f) * Ta * Ta * va * va +
        (1.94544667e-06f) * Ta * Ta * Ta * va * va +
        (1.14099531e-08f) * Ta * Ta * Ta * Ta * va * va +
        (1.58137256e-01f) * va * va * va +
        (-6.57263143e-05f) * Ta * va * va * va +
        (2.22697524e-07f) * Ta * Ta * va * va * va +
        (-4.16117031e-08f) * Ta * Ta * Ta * va * va * va +
        (-1.27762753e-02f) * va * va * va * va +
        (9.66891875e-06f) * Ta * va * va * va * va +
        (2.52785852e-09f) * Ta * Ta * va * va * va * va +
        (4.56306672e-04f) * va * va * va * va * va +
        (-1.74202546e-07f) * Ta * va * va * va * va * va +
        (-5.91491269e-06f) * va * va * va * va * va * va +
        (3.98374029e-01f) * D_Tmrt +
        (1.83945314e-04f) * Ta * D_Tmrt +
        (-1.73754510e-04f) * Ta * Ta * D_Tmrt +
        (-7.60781159e-07f) * Ta * Ta * Ta * D_Tmrt +
        (3.77830287e-08f) * Ta * Ta * Ta * Ta * D_Tmrt +
        (5.43079673e-10f) * Ta * Ta * Ta * Ta * Ta * D_Tmrt +
        (-2.00518269e-02f) * va * D_Tmrt +
        (8.92859837e-04f) * Ta * va * D_Tmrt +
        (3.45433048e-06f) * Ta * Ta * va * D_Tmrt +
        (-3.77925774e-07f) * Ta * Ta * Ta * va * D_Tmrt +
        (-1.69699377e-09f) * Ta * Ta * Ta * Ta * va * D_Tmrt +
        (1.69992415e-04f) * va * va * D_Tmrt +
        (-4.99204314e-05f) * Ta * va * va * D_Tmrt +
        (2.47417178e-07f) * Ta * Ta * va * va * D_Tmrt +
        (1.07596466e-08f) * Ta * Ta * Ta * va * va * D_Tmrt +
        (8.49242932e-05f) * va * va * va * D_Tmrt +
        (1.35191328e-06f) * Ta * va * va * va * D_Tmrt +
        (-6.21531254e-09f) * Ta * Ta * va * va * va * D_Tmrt +
        (-4.99410301e-06f) * va * va * va * va * D_Tmrt +
        (-1.89489258e-08f) * Ta * va * va * va * va * D_Tmrt +
        (8.15300114e-08f) * va * va * va * va * va * D_Tmrt +
        (7.55043090e-04f) * D_Tmrt * D_Tmrt +
        (-5.65095215e-05f) * Ta * D_Tmrt * D_Tmrt +
        (-4.52166564e-07f) * Ta * Ta * D_Tmrt * D_Tmrt +
        (2.46688878e-08f) * Ta * Ta * Ta * D_Tmrt * D_Tmrt +
        (2.42674348e-10f) * Ta * Ta * Ta * Ta * D_Tmrt * D_Tmrt +
        (1.54547250e-04f) * va * D_Tmrt * D_Tmrt +
        (5.24110970e-06f) * Ta * va * D_Tmrt * D_Tmrt +
        (-8.75874982e-08f) * Ta * Ta * va * D_Tmrt * D_Tmrt +
        (-1.50743064e-09f) * Ta * Ta * Ta * va * D_Tmrt * D_Tmrt +
        (-1.56236307e-05f) * va * va * D_Tmrt * D_Tmrt +
        (-1.33895614e-07f) * Ta * va * va * D_Tmrt * D_Tmrt +
        (2.49709824e-09f) * Ta * Ta * va * va * D_Tmrt * D_Tmrt +
        (6.51711721e-07f) * va * va * va * D_Tmrt * D_Tmrt +
        (1.94960053e-09f) * Ta * va * va * va * D_Tmrt * D_Tmrt +
        (-1.00361113e-08f) * va * va * va * va * D_Tmrt * D_Tmrt +
        (-1.21206673e-05f) * D_Tmrt * D_Tmrt * D_Tmrt +
        (-2.18203660e-07f) * Ta * D_Tmrt * D_Tmrt * D_Tmrt +
        (7.51269482e-09f) * Ta * Ta * D_Tmrt * D_Tmrt * D_Tmrt +
        (9.79063848e-11f) * Ta * Ta * Ta * D_Tmrt * D_Tmrt * D_Tmrt +
        (1.25006734e-06f) * va * D_Tmrt * D_Tmrt * D_Tmrt +
        (-1.81584736e-09f) * Ta * va * D_Tmrt * D_Tmrt * D_Tmrt +
        (-3.52197671e-10f) * Ta * Ta * va * D_Tmrt * D_Tmrt * D_Tmrt +
        (-3.36514630e-08f) * va * va * D_Tmrt * D_Tmrt * D_Tmrt +
        (1.35908359e-10f) * Ta * va * va * D_Tmrt * D_Tmrt * D_Tmrt +
        (4.17032620e-10f) * va * va * va * D_Tmrt * D_Tmrt * D_Tmrt +
        (-1.30369025e-09f) * D_Tmrt * D_Tmrt * D_Tmrt * D_Tmrt +
        (4.13908461e-10f) * Ta * D_Tmrt * D_Tmrt * D_Tmrt * D_Tmrt +
        (9.22652254e-12f) * Ta * Ta * D_Tmrt * D_Tmrt * D_Tmrt * D_Tmrt +
        (-5.08220384e-09f) * va * D_Tmrt * D_Tmrt * D_Tmrt * D_Tmrt +
        (-2.24730961e-11f) * Ta * va * D_Tmrt * D_Tmrt * D_Tmrt * D_Tmrt +
        (1.17139133e-10f) * va * va * D_Tmrt * D_Tmrt * D_Tmrt * D_Tmrt +
        (6.62154879e-10f) * D_Tmrt * D_Tmrt * D_Tmrt * D_Tmrt * D_Tmrt +
        (4.03863260e-13f) * Ta * D_Tmrt * D_Tmrt * D_Tmrt * D_Tmrt * D_Tmrt +
        (1.95087203e-12f) * va * D_Tmrt * D_Tmrt * D_Tmrt * D_Tmrt * D_Tmrt +
        (-4.73602469e-12f) * D_Tmrt * D_Tmrt * D_Tmrt * D_Tmrt * D_Tmrt * D_Tmrt +
        (5.12733497f) * Pa +
        (-3.12788561e-01f) * Ta * Pa +
        (-1.96701861e-02f) * Ta * Ta * Pa +
        (9.99690870e-04f) * Ta * Ta * Ta * Pa +
        (9.51738512e-06f) * Ta * Ta * Ta * Ta * Pa +
        (-4.66426341e-07f) * Ta * Ta * Ta * Ta * Ta * Pa +
        (5.48050612e-01f) * va * Pa +
        (-3.30552823e-03f) * Ta * va * Pa +
        (-1.64119440e-03f) * Ta * Ta * va * Pa +
        (-5.16670694e-06f) * Ta * Ta * Ta * va * Pa +
        (9.52692432e-07f) * Ta * Ta * Ta * Ta * va * Pa +
        (-4.29223622e-02f) * va * va * Pa +
        (5.00845667e-03f) * Ta * va * va * Pa +
        (1.00601257e-06f) * Ta * Ta * va * va * Pa +
        (-1.81748644e-06f) * Ta * Ta * Ta * va * va * Pa +
        (-1.25813502e-03f) * va * va * va * Pa +
        (-1.79330391e-04f) * Ta * va * va * va * Pa +
        (2.34994441e-06f) * Ta * Ta * va * va * va * Pa +
        (1.29735808e-04f) * va * va * va * va * Pa +
        (1.29064870e-06f) * Ta * va * va * va * va * Pa +
        (-2.28558686e-06f) * va * va * va * va * va * Pa +
        (-3.69476348e-02f) * D_Tmrt * Pa +
        (1.62325322e-03f) * Ta * D_Tmrt * Pa +
        (-3.14279680e-05f) * Ta * Ta * D_Tmrt * Pa +
        (2.59835559e-06f) * Ta * Ta * Ta * D_Tmrt * Pa +
        (-4.77136523e-08f) * Ta * Ta * Ta * Ta * D_Tmrt * Pa +
        (8.64203390e-03f) * va * D_Tmrt * Pa +
        (-6.87405181e-04f) * Ta * va * D_Tmrt * Pa +
        (-9.13863872e-06f) * Ta * Ta * va * D_Tmrt * Pa +
        (5.15916806e-07f) * Ta * Ta * Ta * va * D_Tmrt * Pa +
        (-3.59217476e-05f) * va * va * D_Tmrt * Pa +
        (3.28696511e-05f) * Ta * va * va * D_Tmrt * Pa +
        (-7.10542454e-07f) * Ta * Ta * va * va * D_Tmrt * Pa +
        (-1.24382300e-05f) * va * va * va * D_Tmrt * Pa +
        (-7.38584400e-09f) * Ta * va * va * va * D_Tmrt * Pa +
        (2.20609296e-07f) * va * va * va * va * D_Tmrt * Pa +
        (-7.32469180e-04f) * D_Tmrt * D_Tmrt * Pa +
        (-1.87381964e-05f) * Ta * D_Tmrt * D_Tmrt * Pa +
        (4.80925239e-06f) * Ta * Ta * D_Tmrt * D_Tmrt * Pa +
        (-8.75492040e-08f) * Ta * Ta * Ta * D_Tmrt * D_Tmrt * Pa +
        (2.77862930e-05f) * va * D_Tmrt * D_Tmrt * Pa +
        (-5.06004592e-06f) * Ta * va * D_Tmrt * D_Tmrt * Pa +
        (1.14325367e-07f) * Ta * Ta * va * D_Tmrt * D_Tmrt * Pa +
        (2.53016723e-06f) * va * va * D_Tmrt * D_Tmrt * Pa +
        (-1.72857035e-08f) * Ta * va * va * D_Tmrt * D_Tmrt * Pa +
        (-3.95079398e-08f) * va * va * va * D_Tmrt * D_Tmrt * Pa +
        (-3.59413173e-07f) * D_Tmrt * D_Tmrt * D_Tmrt * Pa +
        (7.04388046e-07f) * Ta * D_Tmrt * D_Tmrt * D_Tmrt * Pa +
        (-1.89309167e-08f) * Ta * Ta * D_Tmrt * D_Tmrt * D_Tmrt * Pa +
        (-4.79768731e-07f) * va * D_Tmrt * D_Tmrt * D_Tmrt * Pa +
        (7.96079978e-09f) * Ta * va * D_Tmrt * D_Tmrt * D_Tmrt * Pa +
        (1.62897058e-09f) * va * va * D_Tmrt * D_Tmrt * D_Tmrt * Pa +
        (3.94367674e-08f) * D_Tmrt * D_Tmrt * D_Tmrt * D_Tmrt * Pa +
        (-1.18566247e-09f) * Ta * D_Tmrt * D_Tmrt * D_Tmrt * D_Tmrt * Pa +
        (3.34678041e-10f) * va * D_Tmrt * D_Tmrt * D_Tmrt * D_Tmrt * Pa +
        (-1.15606447e-10f) * D_Tmrt * D_Tmrt * D_Tmrt * D_Tmrt * D_Tmrt * Pa +
        (-2.80626406f) * Pa * Pa +
        (5.48712484e-01f) * Ta * Pa * Pa +
        (-3.99428410e-03f) * Ta * Ta * Pa * Pa +
        (-9.54009191e-04f) * Ta * Ta * Ta * Pa * Pa +
        (1.93090978e-05f) * Ta * Ta * Ta * Ta * Pa * Pa +
        (-3.08806365e-01f) * va * Pa * Pa +
        (1.16952364e-02f) * Ta * va * Pa * Pa +
        (4.95271903e-04f) * Ta * Ta * va * Pa * Pa +
        (-1.90710882e-05f) * Ta * Ta * Ta * va * Pa * Pa +
        (2.10787756e-03f) * va * va * Pa * Pa +
        (-6.98445738e-04f) * Ta * va * va * Pa * Pa +
        (2.30109073e-05f) * Ta * Ta * va * va * Pa * Pa +
        (4.17856590e-04f) * va * va * va * Pa * Pa +
        (-1.27043871e-05f) * Ta * va * va * va * Pa * Pa +
        (-3.04620472e-06f) * va * va * va * va * Pa * Pa +
        (5.14507424e-02f) * D_Tmrt * Pa * Pa +
        (-4.32510997e-03f) * Ta * D_Tmrt * Pa * Pa +
        (8.99281156e-05f) * Ta * Ta * D_Tmrt * Pa * Pa +
        (-7.14663943e-07f) * Ta * Ta * Ta * D_Tmrt * Pa * Pa +
        (-2.66016305e-04f) * va * D_Tmrt * Pa * Pa +
        (2.63789586e-04f) * Ta * va * D_Tmrt * Pa * Pa +
        (-7.01199003e-06f) * Ta * Ta * va * D_Tmrt * Pa * Pa +
        (-1.06823306e-04f) * va * va * D_Tmrt * Pa * Pa +
        (3.61341136e-06f) * Ta * va * va * D_Tmrt * Pa * Pa +
        (2.29748967e-07f) * va * va * va * D_Tmrt * Pa * Pa +
        (3.04788893e-04f) * D_Tmrt * D_Tmrt * Pa * Pa +
        (-6.42070836e-05f) * Ta * D_Tmrt * D_Tmrt * Pa * Pa +
        (1.16257971e-06f) * Ta * Ta * D_Tmrt * D_Tmrt * Pa * Pa +
        (7.68023384e-06f) * va * D_Tmrt * D_Tmrt * Pa * Pa +
        (-5.47446896e-07f) * Ta * va * D_Tmrt * D_Tmrt * Pa * Pa +
        (-3.59937910e-08f) * va * va * D_Tmrt * D_Tmrt * Pa * Pa +
        (-4.36497725e-06f) * D_Tmrt * D_Tmrt * D_Tmrt * Pa * Pa +
        (1.68737969e-07f) * Ta * D_Tmrt * D_Tmrt * D_Tmrt * Pa * Pa +
        (2.67489271e-08f) * va * D_Tmrt * D_Tmrt * D_Tmrt * Pa * Pa +
        (3.23926897e-09f) * D_Tmrt * D_Tmrt * D_Tmrt * D_Tmrt * Pa * Pa +
        (-3.53874123e-02f) * Pa * Pa * Pa +
        (-2.21201190e-01f) * Ta * Pa * Pa * Pa +
        (1.55126038e-02f) * Ta * Ta * Pa * Pa * Pa +
        (-2.63917279e-04f) * Ta * Ta * Ta * Pa * Pa * Pa +
        (4.53433455e-02f) * va * Pa * Pa * Pa +
        (-4.32943862e-03f) * Ta * va * Pa * Pa * Pa +
        (1.45389826e-04f) * Ta * Ta * va * Pa * Pa * Pa +
        (2.17508610e-04f) * va * va * Pa * Pa * Pa +
        (-6.66724702e-05f) * Ta * va * va * Pa * Pa * Pa +
        (3.33217140e-05f) * va * va * va * Pa * Pa * Pa +
        (-2.26921615e-03f) * D_Tmrt * Pa * Pa * Pa +
        (3.80261982e-04f) * Ta * D_Tmrt * Pa * Pa * Pa +
        (-5.45314314e-09f) * Ta * Ta * D_Tmrt * Pa * Pa * Pa +
        (-7.96355448e-04f) * va * D_Tmrt * Pa * Pa * Pa +
        (2.53458034e-05f) * Ta * va * D_Tmrt * Pa * Pa * Pa +
        (-6.31223658e-06f) * va * va * D_Tmrt * Pa * Pa * Pa +
        (3.02122035e-04f) * D_Tmrt * D_Tmrt * Pa * Pa * Pa +
        (-4.77403547e-06f) * Ta * D_Tmrt * D_Tmrt * Pa * Pa * Pa +
        (1.73825715e-06f) * va * D_Tmrt * D_Tmrt * Pa * Pa * Pa +
        (-4.09087898e-07f) * D_Tmrt * D_Tmrt * D_Tmrt * Pa * Pa * Pa +
        (6.14155345e-01f) * Pa * Pa * Pa * Pa +
        (-6.16755931e-02f) * Ta * Pa * Pa * Pa * Pa +
        (1.33374846e-03f) * Ta * Ta * Pa * Pa * Pa * Pa +
        (3.55375387e-03f) * va * Pa * Pa * Pa * Pa +
        (-5.13027851e-04f) * Ta * va * Pa * Pa * Pa * Pa +
        (1.02449757e-04f) * va * va * Pa * Pa * Pa * Pa +
        (-1.48526421e-03f) * D_Tmrt * Pa * Pa * Pa * Pa +
        (-4.11469183e-05f) * Ta * D_Tmrt * Pa * Pa * Pa * Pa +
        (-6.80434415e-06f) * va * D_Tmrt * Pa * Pa * Pa * Pa +
        (-9.77675906e-06f) * D_Tmrt * D_Tmrt * Pa * Pa * Pa * Pa +
        (8.82773108e-02f) * Pa * Pa * Pa * Pa * Pa +
        (-3.01859306e-03f) * Ta * Pa * Pa * Pa * Pa * Pa +
        (1.04452989e-03f) * va * Pa * Pa * Pa * Pa * Pa +
        (2.47090539e-04f) * D_Tmrt * Pa * Pa * Pa * Pa * Pa +
        (1.48348065e-03f) * Pa * Pa * Pa * Pa * Pa * Pa;
}
...
void Model::computeCMIndices(Building* pBuilding, Climate* pClimate, unsigned int day, unsigned int hour) {
    ...
    UTCI = evaluateUTCI(Ta, va, Pa, D_Tmrt);
...
float Model::computeGroundUTCI(Ground* pGround, Climate* pClimate, unsigned int day, unsigned int hour) {
    if (pGround == nullptr || pClimate == nullptr) {
        return std::numeric_limits<float>::quiet_NaN();
    }

    const float epsilon = pGround->getLongWaveEmissivity();
    if (epsilon <= 0.f) {
        return std::numeric_limits<float>::quiet_NaN();
    }

    const float shortWaveAbsorbed = pGround->getShortWaveIrradiance() * (1.f - pGround->getShortWaveReflectance());
    const float longWaveAbsorbed = pGround->getLongWaveAbsorbed();
    const float totalRadiativeFlux = std::max(longWaveAbsorbed + shortWaveAbsorbed, 0.f);

    float MRT = std::pow(totalRadiativeFlux / (epsilon * 5.670373e-8f), 0.25f) - 273.15f;

    float va = std::max(0.5f, std::min(pClimate->getWindSpeed(day, hour), 17.f));
    float Ta = std::max(-50.f, std::min(pClimate->getToutCelsius(day, hour), 50.f));

    float ehPa = static_cast<float>(es(Ta)) * pClimate->getRelativeHumidity(day, hour);
    float Pa = std::min(ehPa / 10.f, 5.f);
    ...
    (void)MRT; // Keep variable for potential debugging while avoiding unused warning
